let reg = /Bangladesh/; // This is a regular expression literal in js
//reg = /Bangladesh/g; // g means global
//reg = /Bangladesh/i; // i means case insensitive


let s = "I love Bangladesh. Do you Love Bangladesh?";
...
let result5 = s.replace(reg, 'Dhaka');
console.log(result5);